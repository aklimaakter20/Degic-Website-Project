  ...
  return (
    <section className='py-10 lg:py-16 px-8 md:px-30 mx-auto'>
        <div className='flex flex-col-reverse justify-around md:flex-row items-center gap-20'>
            ...
            <img className='w-16 mb-4 md:w-24 mx-auto md:ms-5' src="logo2.png" alt="" />
            <h1 className='text-2xl md:text-5xl font-bold text-black text-center md:text-left'>{heading}</h1>
            ...
            <div className='w-full md:w-1/2 flex justify-center'>
                <img className='w-full md:w-[65%] object-cover' src={img} />
            </div>
        </div>
